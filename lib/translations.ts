...
export const translations = {
  en: {
    ...
    // Sign In & Sign Up
    authSignInTitle: "Welcome to BiteFlow",
    authSignInSubtitle: "Sign in to order your favorite fresh dishes.",
    authSignUpTitle: "Create Account",
    authSignUpSubtitle: "Join BiteFlow to start placing delicious orders.",
  ...
  ar: {
    ...
    // Sign In & Sign Up
    authSignInTitle: "مرحباً بك في بايت فلو",
    authSignInSubtitle: "سجل دخولك لتتمكن من طلب أطباقك الطازجة المفضلة.",
    authSignUpTitle: "إنشاء حساب جديد",
    authSignUpSubtitle: "انضم إلى بايت فلو وابدأ بطلب وجباتك الشهية.",
    ...
    authPlaceholderUsername: "مثال: foodlover123",
    authPlaceholderEmail: "yourname@example.com",
    authPlaceholderPassword: "••••••••",
    authPlaceholderConfirmPassword: "••••••••",
    authBtnSignIn: "تسجيل الدخول",
    authBtnSignUp: "إنشاء حساب",
    authSigningIn: "جاري تسجيل الدخول...",
    authRegistering: "جاري تسجيل الحساب...",
    authBackMenu: "العودة للقائمة الرئيسية",
    authNewToBiteFlow: "جديد في بايت فلو؟",
    authCreateAccountLink: "أنشئ حساباً جديداً",
    authAlreadyHaveAccount: "لديك حساب بالفعل؟",
    authSignInInstead: "سجل دخولك بدلاً من ذلك",
    authVerifyingSession: "جاري التحقق من الجلسة...",
